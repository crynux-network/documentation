...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><a href="https://drive.google.com/uc?id=12uw7mZ0LvcpE2vqG2hub4_29wEJTJNtL&export=download">crynux-node-lithium-v3.5.0-base-windows-x64.zip</a></td>
        </tr>
        <tr>
            <td>Base</td>
            <td>Mac</td>
            <td>M1/M2/M3 and later</td>
            <td><a href="https://github.com/crynux-network/crynux-node/releases/download/v3.5.0/crynux-node-lithium-v3.5.0-base-mac-arm64-unsigned.dmg">crynux-node-lithium-v3.5.0-base-mac-arm64-signed.dmg</a></td>
        </tr>
        <tr>
            <td>Near</td>
            <td>Windows</td>
            <td>Nvidia GPU with 8GB VRAM</td>
            <td><a href="https://drive.google.com/uc?id=1JbkaQagvsXSiHCsANDB4hXiURR2wjb9p&export=download">crynux-node-lithium-v3.5.0-near-windows-x64.zip</a></td>
        </tr>
        <tr>
            <td>Near</td>
            <td>Mac</td>
            <td>M1/M2/M3 and later</td>
            <td><a href="https://github.com/crynux-network/crynux-node/releases/download/v3.5.0/crynux-node-lithium-v3.5.0-near-mac-arm64-unsigned.dmg">crynux-node-lithium-v3.5.0-near-mac-arm64-signed.dmg</a></td>
        </tr>
    </tbody>
</table>
